...
```bash
curl -L raw.esm.sh/gh/wyf027/leno23-installer/i|sh
```

That installs into the current directory. To choose a target directory:

```bash
curl -L raw.esm.sh/gh/wyf027/leno23-installer/i|sh -s ~/Code/leno23
```
...
```bash
curl -L raw.esm.sh/gh/you/your-installer/i | \
